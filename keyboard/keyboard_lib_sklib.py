...
keyboard_lib = SchLib(tool=SKIDL).add_parts(*[
        Part(**{ 'name':'USB_C_Receptacle_USB2.0', 'dest':TEMPLATE, 'tool':SKIDL, 'F3':'', 'F2':'', 'F1':'USB_C_Receptacle_USB2.0', 'datasheet':'https://www.usb.org/sites/default/files/documents/usb_type-c.zip', 'keywords':'usb universal serial bus type-C USB2.0', 'F0':'J', 'match_pin_substring':False, 'manf#':'TYPE-C-31-M-12', 'description':'USB 2.0-only Type-C Receptacle connector', 'ref_prefix':'J', 'num_units':1, 'fplist':['USB*C*Receptacle*'], 'do_erc':True, 'aliases':Alias(), 'pin':None, 'footprint':'USB_C_Receptacle_HRO_TYPE-C-31-M-12', 'pins':[
        ...
        Part(**{ 'name':'R', 'dest':TEMPLATE, 'tool':SKIDL, 'F3':'', 'F2':'', 'F1':'R', 'datasheet':'~', 'keywords':'R res resistor', 'F0':'R', 'match_pin_substring':False, 'description':'Resistor', 'ref_prefix':'R', 'num_units':1, 'fplist':['R_*'], 'do_erc':True, 'aliases':Alias(), 'pin':None, 'footprint':'Resistor_SMD:R_0805_2012Metric', 'pins':[
            Pin(num='1',name='~',func=Pin.types.PASSIVE,do_erc=True),
            Pin(num='2',name='~',func=Pin.types.PASSIVE,do_erc=True)] }),
        Part(**{ 'name':'Fuse', 'dest':TEMPLATE, 'tool':SKIDL, 'F3':'', 'F2':'', 'F1':'Fuse', 'datasheet':'~', 'keywords':'fuse', 'F0':'F', 'match_pin_substring':False, 'manf#':'JK-MSMD050', 'description':'Fuse', 'ref_prefix':'F', 'num_units':1, 'fplist':['*Fuse*'], 'do_erc':True, 'aliases':Alias(), 'pin':None, 'footprint':'Fuse:Fuse_1812_4532Metric', 'pins':[
            Pin(num='1',name='~',func=Pin.types.PASSIVE,do_erc=True),
            Pin(num='2',name='~',func=Pin.types.PASSIVE,do_erc=True)] }),
        Part(**{ 'name':'ATmega16U4-AU', 'dest':TEMPLATE, 'tool':SKIDL, 'F3':'', 'F2':'Package_QFP:TQFP-44_10x10mm_P0.8mm', 'F1':'ATmega16U4-AU', 'datasheet':'http://ww1.microchip.com/downloads/en/DeviceDoc/Atmel-7766-8-bit-AVR-ATmega16U4-32U4_Datasheet.pdf', 'keywords':'AVR 8bit Microcontroller MegaAVR USB', '_aliases':Alias({'ATmega32U4-AU', 'ATmega32U4RC-AU', 'ATmega16U4RC-AU'}), 'F0':'U', 'match_pin_substring':False, 'manf#':'ATMEGA32U4-AU', 'description':'16MHz, 32kB Flash, 2.5kB SRAM, 1kB EEPROM, USB 2.0, RC Osc, TQFP-44', 'ref_prefix':'U', 'num_units':1, 'fplist':['TQFP*10x10mm*P0.8mm*'], 'do_erc':True, 'aliases':Alias({'ATmega32U4-AU', 'ATmega32U4RC-AU', 'ATmega16U4RC-AU'}), 'pin':None, 'footprint':'Package_QFP:TQFP-44_10x10mm_P0.8mm', 'pins':[
        ...
        Part(**{ 'name':'LED_Small', 'dest':TEMPLATE, 'tool':SKIDL, 'F3':'', 'F2':'', 'F1':'LED_Small', 'datasheet':'~', 'keywords':'LED diode light-emitting-diode', 'F0':'D', 'match_pin_substring':False, 'description':'Light emitting diode, small symbol', 'ref_prefix':'D', 'num_units':1, 'fplist':['LED*', 'LED_SMD:*', 'LED_THT:*'], 'do_erc':True, 'aliases':Alias(), 'pin':None, 'footprint':'LED_SMD:LED_0805_2012Metric', 'pins':[
            Pin(num='1',name='K',func=Pin.types.PASSIVE,do_erc=True),
            Pin(num='2',name='A',func=Pin.types.PASSIVE,do_erc=True)] }),
        Part(**{ 'name':'C', 'dest':TEMPLATE, 'tool':SKIDL, 'F3':'', 'F2':'', 'F1':'C', 'datasheet':'~', 'keywords':'cap capacitor', 'F0':'C', 'match_pin_substring':False, 'description':'Unpolarized capacitor', 'ref_prefix':'C', 'num_units':1, 'fplist':['C_*'], 'do_erc':True, 'aliases':Alias(), 'pin':None, 'footprint':'Capacitor_SMD:C_0805_2012Metric', 'pins':[
            Pin(num='1',name='~',func=Pin.types.PASSIVE,do_erc=True),
            Pin(num='2',name='~',func=Pin.types.PASSIVE,do_erc=True)] }),
        Part(**{ 'name':'Crystal_Small', 'dest':TEMPLATE, 'tool':SKIDL, 'F3':'', 'F2':'', 'F1':'Crystal_Small', 'datasheet':'~', 'keywords':'quartz ceramic resonator oscillator', 'F0':'Y', 'match_pin_substring':False, 'manf#':'X503216MSB2GI', 'description':'Two pin crystal, small symbol', 'ref_prefix':'Y', 'num_units':1, 'fplist':['Crystal*'], 'do_erc':True, 'aliases':Alias(), 'pin':None, 'footprint':'Crystal:Crystal_SMD_5032-2Pin_5.0x3.2mm', 'pins':[
            Pin(num='1',name='1',func=Pin.types.PASSIVE,do_erc=True),
            Pin(num='2',name='2',func=Pin.types.PASSIVE,do_erc=True)] }),
        Part(**{ 'name':'SW_PUSH', 'dest':TEMPLATE, 'tool':SKIDL, 'F3':'', 'F2':'', 'F1':'SW_PUSH', 'datasheet':'', 'keywords':'', 'F0':'SW', 'match_pin_substring':False, 'description':'', 'ref_prefix':'SW', 'num_units':1, 'fplist':[], 'do_erc':True, 'aliases':Alias(), 'pin':None, 'footprint':'kbd:CherryMX_Hotswap', 'pins':[
            Pin(num='1',name='1',func=Pin.types.PASSIVE,do_erc=True),
            Pin(num='2',name='2',func=Pin.types.PASSIVE,do_erc=True)] }),
        Part(**{ 'name':'D', 'dest':TEMPLATE, 'tool':SKIDL, 'F3':'', 'F2':'', 'F1':'D', 'datasheet':'~', 'keywords':'diode', 'F0':'D', 'match_pin_substring':False, 'description':'Diode', 'ref_prefix':'D', 'num_units':1, 'fplist':['TO-???*', '*_Diode_*', '*SingleDiode*', 'D_*'], 'do_erc':True, 'aliases':Alias(), 'pin':None, 'footprint':'kbd:D3_SMD_v2', 'pins':[
            Pin(num='1',name='K',func=Pin.types.PASSIVE,do_erc=True),
            Pin(num='2',name='A',func=Pin.types.PASSIVE,do_erc=True)] }),
        Part(**{ 'name':'YS-SK6812MINI-E', 'dest':TEMPLATE, 'tool':SKIDL, 'F3':'', 'F2':'', 'F1':'YS-SK6812MINI-E', 'datasheet':'', 'keywords':'', 'F0':'LED', 'match_pin_substring':False, 'description':'', 'ref_prefix':'LED', 'num_units':1, 'fplist':[], 'do_erc':True, 'aliases':Alias(), 'pin':None, 'footprint':'kbd:YS-SK6812MINI-E', 'pins':[
